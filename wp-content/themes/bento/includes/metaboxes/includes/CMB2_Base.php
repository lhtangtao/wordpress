		...
		if ( is_numeric( $message ) ) {
			...
			switch ( $message ) {
				...
				case self::DEPRECATED_PARAM:
					$message = sprintf( __( 'The "%s" field parameter has been deprecated in favor of the "%s" parameter.', 'bento' ), $args[3], $args[4] );
					break;

				case self::DEPRECATED_CB_PARAM:
					$message = sprintf( __( 'Using the "%s" field parameter as a callback has been deprecated in favor of the "%s" parameter.', 'bento' ), $args[3], $args[4] );
					break;
