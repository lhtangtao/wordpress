...
//清理header
      ...
      require 'theme-updates/theme-update-checker.php';
	    $example_update_checker = new ThemeUpdateChecker(	
		 'magicmagazine_free', 
         'http://www.themepark.com.cn/free_themes/2016/magicmagazine_free/magicmagazine_free.json'  //info.json 的访问地址
);
...
if ( function_exists( 'add_image_size' ) ) {
 ...
 function themepark_thumbnails($thumbnail_size){
	  $id =get_the_ID(); 
	  if(get_option('mytheme_'.$thumbnail_size.'_thumbnails')){$case_thumbnails=get_option('mytheme_'.$thumbnail_size.'_thumbnails');}else{$case_thumbnails= get_bloginfo('template_url').'/images/thumbnails/'.$thumbnail_size.'.jpg';} 
