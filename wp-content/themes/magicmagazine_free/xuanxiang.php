...
$customize_title = sprintf( __( 'Customize &#8220;%s&#8221;' ), $ct->display('Name') );
 ?>
        <p><b>主题名称：<?php echo $ct->display('Name'); ?></b> <a class="banben">版本：<?php echo $ct->display('Version'); ?></a>
         <a  href="http://www.themepark.com.cn/mszzwordpressqyzt.html" target="_blank" class="jieshao">详细介绍</a> 
        <a href="http://www.themepark.com.cn/?s=%E9%AD%94%E6%9C%AF%E6%9D%82%E5%BF%97&cat=7,8,56" target="_blank" class="bangzhu">相关教程、付费版视频等</a></p>
        <p><b>主题出品：</b><a target="_blank" href="http://www.themepark.com.cn"><?php echo $ct->display('Author'); ?></a> 
        <a href=" http://www.themepark.com.cn/mszzwordpressqyzt.html" target="_blank">免费版升级到付费版时，绝大部分的数据可以得到继承，</a></p>
    </div>
    <div class="biaodan">
<div class="tishi2">
